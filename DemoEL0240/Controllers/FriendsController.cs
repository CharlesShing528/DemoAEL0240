...
namespace DemoEL0240.Controllers
{
    public class FriendsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email,City,Country")] Friend friend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,City,Country")] Friend friend)
        {
            if (id != friend.Id)
            {
                return NotFound();
